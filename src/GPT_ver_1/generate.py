...
from bible_text_generation_web_app.src.GPT_ver_1.model import GPT
from bible_text_generation_web_app.src.GPT_ver_1.process_data import *
...
class Generation:
    def __init__(self, *args, **kwargs):              
        ...
        self.model.load_state_dict(
            torch.load('src/GPT_ver_1/GPT_1.pt', 
